...
# This script runs kraken2 to classify
# reads after the de-contamination procedure.
# We expect to see >95% of the reads mapping on Nitrospirae
...
OUT_DIR="$HOME/prj/data/DNA_data/kraken2/04_decontamination_test"
