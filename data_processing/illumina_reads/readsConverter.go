...
func parseArgs() cmdArgs {
	...
	flag.BoolVar(&args.PE, "PE", true, "use PE to process paired end reads")
	flag.Parse()

	return args
}

func converterSTDIO(PE bool) {
...
func converter(fileName string, compressionLevel int, PE bool) {
...
func main() {
	...
	for _, fileName := range fileList {
		if re.MatchString(fileName) {
			converter(fileName, args.compressionLevel, args.PE)
		}
	}
}
